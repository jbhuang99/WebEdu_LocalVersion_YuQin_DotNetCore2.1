...
var chatClient = new OpenAIClient(
        ...
        new ApiKeyCredential(openAIProvider.ApiKey),//本机模型不需要APIKey，直接使用本机模型的Endpoint即可。
        //new ApiKeyCredential(""),//出错
...
Console.WriteLine(openAIProvider.ApiKey + openAIProvider.Endpoint + openAIProvider.ModelId);
