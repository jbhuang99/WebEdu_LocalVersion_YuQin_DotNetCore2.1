...
{
    //[Authorize()]
    public class RunableLocalLLMController : ControllerBase
    {
        ...
        public RunableLocalLLMController(IWebHostEnvironment iWebHostEnvironment, IConfiguration iConfiguration)
        {
        ...
        public async Task<string> Index()
        {
            ...
            foreach (var catalogModel in cachedModels)
            {
                var modelViewModel = new ModelViewModel
                {
