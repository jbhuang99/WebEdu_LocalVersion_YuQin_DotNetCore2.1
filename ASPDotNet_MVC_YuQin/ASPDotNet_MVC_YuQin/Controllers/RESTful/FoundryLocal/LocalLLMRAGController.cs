...
namespace WebEdu_LocalVersion_YuQin_DotNetCore21.Controllers.LocalLLM
{
    //[Authorize()]
    public class LocalLLMRAGController : Controller
    {
        ...
        public LocalLLMRAGController(IHostingEnvironment hostingEnvironment)//通过注入 IHostingEnvironment 服务对象来取得Web根目录和内容根目录的物理路径
        {
