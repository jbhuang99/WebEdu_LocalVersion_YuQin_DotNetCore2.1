...
{
    //[Authorize()]
    public class StartServiceFoundryLocalController : ControllerBase
    {
        private readonly IWebHostEnvironment _iWebHostEnvironment;
        private readonly IConfiguration _iConfiguration;

        public StartServiceFoundryLocalController(IWebHostEnvironment iWebHostEnvironment, IConfiguration iConfiguration)
        {
