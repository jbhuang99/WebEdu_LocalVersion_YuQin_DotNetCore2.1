...
function fnAOnMouseOn() {
    ...
    event.srcElement.setAttribute("title", event.srcElement.childNodes.item(0).nodeValue+'\n\n【数智时代的人机统一的翻转课堂：“作业测验”驱动“目录导航的课文、面向一对一的学生课前自主学习、面向一对多的教师课堂答疑教学”】'+'\n【注：单击标题框架的“概览”可以查看当前条目是否具有“课文”、“作业测验”等等各种文档。它们可能进一步链接字符媒体/多媒体文档】\n【注：单击标题框架的“内容切换”可以切换内容框架中的“课文/作业测验”……】【建议：“作业测验”驱动“目录导航的课文↔面向一对一的学生课前自主学习↔面向一对多的教师课堂答疑教学”（“目录导航的课文”主选“作业测验”采集数据、“面向一对一的学生课前自主学习”主选“作业测验”实施学习、“面向一对多的教师课堂答疑教学”主选“作业测验”的“答案解释”链接实施教学的字符文档/图像PPT/视频/2D/3D的视媒/听媒/触媒/嗅媒/味媒）……“本翻转课堂模式”兼容“传统课堂模式”……】\n\n注：本系统的“标题”/“目录”/“内容”的框架：\n（1）遵循业界的知识导航事实标准【例如，外部网站所示：https://learn.microsoft.com/en-us/microsoft-edge/developer/】【例如：操作系统的文件系统所示】【例如：Word长文档所示】\n（2）但又追求“目录条目导航的作业测验”驱动“教材课文”的教与学，等等的创新【例如，本系统网站所示：https://jbhuang99.github.io/WebEdu_LocalVersion_YuQin_DotNetCore2.1/ASPDotNet_MVC_YuQin/ASPDotNet_MVC_YuQin/wwwroot/webCourse/common/iframeInitial.html?iWidth=1024&iHeight=738&text=1676365271966】');
}
 ...
 var sHomeworkAndTest = window.oSrcElement.parentNode.getAttribute("homeworkAndTest");
    if (sHomeworkAndTest == "" || sHomeworkAndTest == null) {
       ...
       var doc = parent.document.getElementById("sIframeHomeworkAndTest").contentDocument || parent.document.getElementById("sIframeHomeworkAndTest").contentWindow.document;
        if ((doc.body.innerText.includes("404") &&doc.body.innerText.includes("localhost"))||(doc.body.innerText.includes("404") &&doc.body.innerText.includes("File not found")&&doc.body.innerText.includes("GitHub Pages"))||doc.body.innerText=="") {
             parent.document.getElementById("sIframeHomeworkAndTest").contentWindow.location.href = "../options/NotFindHomeworkAndTest.htm";
        }
       } 
       catch(e) {
