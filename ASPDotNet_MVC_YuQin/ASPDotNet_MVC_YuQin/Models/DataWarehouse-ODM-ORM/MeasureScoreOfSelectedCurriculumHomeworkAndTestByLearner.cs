...
namespace CurriculumSelectionDW.Models
{
    public class MeasureScoreOfSelectedCurriculumHomeworkAndTestByLearner : Object
    {
       ...
       //public String ScoreOfSelectedCurriculumHomeworkAndTestByLearnerNote { get; set; }
        ...
        public DimCurriculumHomeworkAndTest CurriculumHomeworkAndTest { get; set; }
        public DimLearner Learner { get; set; }
        public DimCurriculumHomeworkAndTestSelectedTime CurriculumHomeworkAndTestSelectedTime { get; set; }
