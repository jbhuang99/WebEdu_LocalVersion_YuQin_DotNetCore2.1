请了解：.exe文件形式的SQL Server收费大型数据库（内置SQL Server LocalDB免费小型数据库）的下载安装使用【Microsoft公司】→.dll文件形式的SQLite免费小型数据库的VS的“SQLite/SQL Server Compact Toolbox”插件的下载安装使用【D.RichardHipp公司】。
