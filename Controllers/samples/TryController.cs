...
public class TryController:Controller
{
    ...
    {
        return this.Content("这是返回字符串到浏览器端的示例（而不返回视图V），浏览器端将打开一个自已默认的界面呈现所返回的字符串");
    }
    ...
    public ViewResult TryPartialView()
    {
        return this.View("/Views/Samples/TryPartialView/index.cshtml");
    }
    public PartialViewResult PartialViewReturned()
    {
        return this.PartialView("/Views/Samples/TryController/tryView.cshtml");
    }
