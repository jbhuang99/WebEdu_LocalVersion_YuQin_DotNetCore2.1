...
namespace CurriculumSelectionWithInheritance.Controllers
{
    #region snippet
    public class StudentsController : Controller
    {
        private readonly CurriculumSelectionWithInheritanceDbContext _schoolDBContext;

        public StudentsController(CurriculumSelectionWithInheritanceDbContext schoolDBContext)
        {
        ...
        public async Task<IActionResult> Details(Int32? id)
        {
           ...
           Learner student = await _schoolDBContext.LearnerDbSet.FromSqlRaw($"SELECT * FROM dbo.Person WHERE LearnerID={id}").FirstOrDefaultAsync();
