...
self.addEventListener('install', function (event) { //Install(service workers的生命周期之一)：在用户第一次访问页面时触发安装事件。在这个阶段中，service workers被安装在浏览器中。在安装过程中，您可以将Web app的所有静态资产缓存下来。
